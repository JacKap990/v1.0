        ...
        <ToastContext.Provider value={{ showToast }}>
            ...
            <div className="fixed bottom-24 left-0 right-0 z-[100] flex flex-col items-center gap-2 pointer-events-none px-4">
                {toasts.map((toast) => (
                    <div
                        key={toast.id}
                        className={`pointer-events-auto flex items-center gap-3 px-4 py-3 rounded-2xl shadow-xl max-w-sm w-full backdrop-blur-md border animate-in fade-in slide-in-from-bottom-4 duration-300 ${toast.type === "success"
