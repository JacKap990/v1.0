        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-[200] flex items-end sm:items-center justify-center p-0 sm:p-4">
                ...
                <motion.div
                    ...
                    className="bg-white/95 backdrop-blur-xl w-full sm:max-w-md h-[90vh] sm:h-[85vh] sm:rounded-[40px] rounded-t-[40px] shadow-2xl flex flex-col overflow-hidden relative"
