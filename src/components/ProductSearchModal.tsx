        ...
        <AnimatePresence>
            ...
            >
                ...
                <motion.div
                    ...
                    className="relative bg-white/95 backdrop-blur-2xl w-full max-w-lg sm:rounded-[40px] rounded-t-[40px] shadow-2xl flex flex-col max-h-[90vh] overflow-hidden"
                            ...
                            <div className="space-y-3">
                                {results.map((product, idx) => (
                                    <motion.button
                                        ...
                                        className="w-full bg-white p-4 rounded-[28px] flex items-center gap-4 hover:shadow-lg hover:shadow-emerald-500/5 active:scale-[0.98] transition-all border border-slate-100 hover:border-emerald-200 group relative overflow-hidden"
                                    >
                    ...
                    {query.trim().length >= 2 && (
                        <div className="absolute bottom-0 left-0 right-0 p-4 bg-white/90 backdrop-blur-md border-t border-slate-100">
                            <motion.button
                                ...
                                className="w-full bg-gradient-to-tr from-emerald-600 via-emerald-500 to-cyan-500 text-white p-4 rounded-[24px] font-black text-sm flex items-center justify-center gap-3 active:scale-[0.98] transition-all shadow-xl shadow-emerald-200 relative overflow-hidden group"
                            >
